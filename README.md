...
This is a template for creating a [HL7 Switzerland](https://www.hl7.ch/) FHIR implementation guide ([CI Build](http://build.fhir.org/ig/ahdis/ch-ig-lab-lr/branches/master/index.html)). Sample resources are integrated as fsh files (`ch-ig-lab-lr\input\fsh`).   
...
**FSH (FHIR Shorthand)**    
To set up a FHIR Shorthand (FSH) implementation guide use this template or see the instructions [here](https://fshschool.org/docs/sushi/project/). Don't forget to [install SUSHI](https://fshschool.org/docs/sushi/installation/). ([CI Build](http://build.fhir.org/ig/ahdis/ch-ig-lab-lr/branches/master/index.html))  
...
* See the output:
   * Validation results (QA): .\ch-ig-lab-lr\output\qa.html (link is displayed in the command line)
   * Implementation guide: .\ch-ig-lab-lr\output\index.html (replace qa with index)
...
* Then clone the repository via the terminal: `git clone https://github.com/ahdis/ch-ig-lab-lr.git`
* Open the folder of the repository in VSC (File > Open Folder...)
* Navigate to this repository in the therminal (`cd .\ch-ig-lab-lr\ `)
...
* Copy the link from the result in your terminal in a web browser (`file:///C:/Users/username/Documents/GitHub/ch-ig-lab-lr/qa.html`)
